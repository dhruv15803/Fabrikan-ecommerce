...
const AdminAddProductForm = ({ setProducts }: Props) => {
  ...
  const [isSubmittingProduct, setIsSubmittingProduct] =
    ...
    <>
      <div className="flex flex-col gap-4 mx-10 mb-4">
        <form
          ...
          className="p-4 border flex flex-col rounded-lg shadow-md gap-4"
        >
          <div className="text-xl font-semibold border-b p-2">Add product</div>
          ...
          <Button disabled={isSubmittingProduct} className="my-4">
